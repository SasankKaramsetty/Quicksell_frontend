...
const TicketGroup = ({ bucket, bucketName }) => {
    ...
    return (
        <div>
            <div className="tick">
                <span>
                    <img src={TitleToImg[bucketName]} alt={`${displayName} Icon`} className="sticon" />
                </span>
                <section className="p">{displayName}</section> 
                <span className="no">{bucket.length}</span>
                <div className="pIcon">
                    <img src={add} alt="add Icon" className="icon" />
                    <img src={tdot} alt="tdot Icon" className="icon" />
                </div>
            </div>

            <div className="pragna">
                {bucket.map((card, ind) => {
